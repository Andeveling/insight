...
import type { MaturityLevel, QuestType } from '@/lib/types/strength-levels.types';
 ...
 */
export const XP_THRESHOLDS: Record<MaturityLevel, { min: number; max: number | null }> = {
 ...
 */
export const LEVEL_METADATA: Record<MaturityLevel, {
  name: string;
  nameEs: string;
  color: string;
  bgGradient: string;
...
export const CLIP_PATHS = {
  card16: 'polygon(16px 0, 100% 0, 100% calc(100% - 16px), calc(100% - 16px) 100%, 0 100%, 0 16px)',
  button8: 'polygon(8px 0, 100% 0, 100% calc(100% - 8px), calc(100% - 8px) 100%, 0 100%, 0 8px)',
  hexagon: 'polygon(50% 0, 100% 25%, 100% 75%, 50% 100%, 0 75%, 0 25%)',
  badge4: 'polygon(4px 0, 100% 0, 100% calc(100% - 4px), calc(100% - 4px) 100%, 0 100%, 0 4px)',
} as const;
