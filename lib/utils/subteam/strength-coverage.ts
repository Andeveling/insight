...
export function calculateStrengthCoverage(
  ...
  const coveragePercentage = idealStrengths.length > 0 ? matchedStrengths.length / idealStrengths.length : 0;
 ...
 */
export function calculateDomainDistribution(members: MemberStrengthData[]): DomainDistribution {
 ...
 */
export function normalizeDomainDistribution(distribution: DomainDistribution): DomainDistribution {
