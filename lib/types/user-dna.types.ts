...
export const UserDnaDimensionSchema = z.object({
	...
	strengths: z
		.array(z.string())
		.describe("Lista de fortalezas involucradas en esta dimensión"),
	description: z
		.string()
		.describe("Descripción de cómo interactúan estas fortalezas"),
});

export const UserDnaSynergySchema = z.object({
	strengths: z
		.array(z.string())
		.describe("Par de fortalezas que crean la sinergia"),
...
export const UserDnaSchema = z.object({
	...
	dimensions: z
		.array(UserDnaDimensionSchema)
		.describe("Análisis por dimensiones"),
