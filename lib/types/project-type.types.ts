 ...
 *
 * @module lib/types/project-type.types
 */
 ...
 */
export const PROJECT_TYPE_SEED_DATA: Omit<
	ProjectTypeProfile,
...
>[] = [
	{
		...
		description:
			"Projects focused on creating new products, services, or processes requiring creative thinking and strategic planning.",
		descriptionEs:
			"Proyectos enfocados en crear nuevos productos, servicios o procesos que requieren pensamiento creativo y planificación estratégica.",
		icon: "lightbulb",
		characteristics: [
	...
	},
	{
		...
		description:
			"Projects with clear objectives and tight deadlines requiring disciplined execution and delivery excellence.",
		descriptionEs:
			"Proyectos con objetivos claros y plazos ajustados que requieren ejecución disciplinada y excelencia en la entrega.",
		icon: "target",
		characteristics: [
	...
	},
	{
		...
		description:
			"Urgent projects requiring rapid decision-making, problem-solving, and team coordination under pressure.",
		descriptionEs:
			"Proyectos urgentes que requieren toma de decisiones rápida, resolución de problemas y coordinación de equipo bajo presión.",
		icon: "alert-triangle",
		characteristics: [
	...
	},
	{
		...
		description:
			"Projects focused on team development, culture building, and organizational growth initiatives.",
		descriptionEs:
			"Proyectos enfocados en desarrollo de equipos, construcción de cultura e iniciativas de crecimiento organizacional.",
		icon: "trending-up",
		characteristics: [
...
export function getProjectTypeProfile(
	type: ProjectType,
): Omit<ProjectTypeProfile, "id" | "createdAt" | "updatedAt"> | undefined {
