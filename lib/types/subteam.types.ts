 ...
 *
 * @module lib/types/subteam.types
 */

import { z } from "zod";

import type { ProjectTypeProfile } from "./project-type.types";
...
/**
 * Suggested member to fill a strength gap
 */
...
export type CalculateMatchScoreInput = z.infer<
	typeof calculateMatchScoreSchema
>;
