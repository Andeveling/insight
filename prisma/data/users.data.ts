...
export const usersData: UserProfileSeed[] = [
	...
	},
	{
		...
		gender: "F",
		description:
			"Madre de Vale, Samu y Jero, Especialista en experiencia de usuario y bienestar organizacional.",
		hobbies: ["Leer"],
...
Cada desafío lo asumo como una oportunidad para aprender y crecer. Amo la narración en todas sus formas: sea en la radio, en un guion cinematográfico o en una simple pero poderosa publicación en redes sociales.`,
	...
	},
	{
		...
		gender: "M",
		description:
			"Desarrollador web apasionado por la IA, automatización y el aprendizaje continuo hice un cambio de carrera a mis 37 anos de la instalacion de ventanas en PVC en obras a ser desarrollador, en mi futuro quiero ser un Engineer Lead ya que disfruto crear apps.",
