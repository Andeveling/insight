...
export function LoginForm({
	...
	return (
		<div
			className={cn("flex flex-col gap-6 w-full relative", className)}
			{...props}
		>
			...
			>
				...
				>
					...
					<div className="absolute top-0 left-0 w-full h-px bg-primary/20 z-20 pointer-events-none animate-scan" />
