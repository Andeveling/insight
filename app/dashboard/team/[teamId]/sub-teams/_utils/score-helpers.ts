...
export function getScoreInfo(score: number | null): {
  ...
  if (score === null) {
    return { color: 'bg-muted text-muted-foreground', label: 'N/A', description: '' };
  }
...
export function getDomainColor(domainName: string): string {
  const colors: Record<string, string> = {
    Thinking: 'bg-violet-100 text-violet-800 dark:bg-violet-900/30 dark:text-violet-400',
    Relating: 'bg-rose-100 text-rose-800 dark:bg-rose-900/30 dark:text-rose-400',
    Executing: 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400',
    Influencing: 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400',
    'Strategic Thinking': 'bg-violet-100 text-violet-800 dark:bg-violet-900/30 dark:text-violet-400',
    'Relationship Building': 'bg-rose-100 text-rose-800 dark:bg-rose-900/30 dark:text-rose-400',
  };
