		...
		>
			...
			>
				...
				<div className="space-y-4">
					{[1, 2, 3].map((i) => (
						<div key={i} className="flex gap-4 p-3 border border-border/50 bg-muted/20">
	...
	return (
		<div className="space-y-6">
				...
				<div className="bg-background/80 p-8" style={{ clipPath: clipPath16 }}>
					<div className="flex flex-col md:flex-row items-baseline md:items-center justify-between gap-8">
						<div className="flex items-center gap-6">
							<Skeleton className="h-20 w-20 bg-muted/20" style={{ clipPath: "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)" }} />
			...
			<div className="grid grid-cols-2 md:grid-cols-4 gap-4">
				{[1, 2, 3, 4].map((i) => (
					<div key={i} className="p-px bg-border/40" style={{ clipPath: clipPath12 }}>
						<div className="bg-background/80 p-6" style={{ clipPath: clipPath12 }}>
							<div className="flex items-center gap-4">
								<Skeleton className="h-10 w-10 bg-muted/10 shrink-0" style={{ clipPath: "polygon(50% 0, 100% 25%, 100% 75%, 50% 100%, 0 75%, 0 25%)" }} />
			...
			<div className="grid md:grid-cols-2 gap-6">
				{[1, 2].map((i) => (
					<div key={i} className="p-px bg-border/40" style={{ clipPath: clipPath16 }}>
						<div className="bg-background/80 p-6" style={{ clipPath: clipPath16 }}>
							<div className="flex items-center gap-3 mb-6">
								<Skeleton className="h-10 w-10 bg-muted/10" style={{ clipPath: "polygon(50% 0, 100% 25%, 100% 75%, 50% 100%, 0 75%, 0 25%)" }} />
							...
							<div className="space-y-4">
								...
								<div className="space-y-3">
									{[1, 2, 3].map((j) => (
										<Skeleton key={j} className="h-12 w-full bg-muted/10" style={{ clipPath: clipPath8 }} />
									))}
								</div>
							</div>
						</div>
			...
			<div className="flex gap-4">
				<Skeleton className="h-12 w-48 bg-muted/20" style={{ clipPath: "polygon(0 0, 100% 0, 100% calc(100% - 10px), calc(100% - 10px) 100%, 0 100%)" }} />
				<Skeleton className="h-12 w-40 bg-muted/20" style={{ clipPath: "polygon(0 0, 100% 0, 100% calc(100% - 10px), calc(100% - 10px) 100%, 0 100%)" }} />
			</div>
		</div>
	);
}
