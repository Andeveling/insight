...
export function ModuleCard({
  ...
  const [started, setStarted] = useState(module.progress.status !== "not_started");
  ...
  const clipPathStyle = "polygon(16px 0, 100% 0, 100% calc(100% - 16px), calc(100% - 16px) 100%, 0 100%, 0 16px)";
      ...
      >
        ...
        <div 
          className={cn(
            ...
            isActive ? "bg-zinc-950/70 backdrop-blur-sm" : "bg-zinc-950/90 backdrop-blur-sm"
          )}
          style={{ clipPath: clipPathStyle }}
        >
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="space-y-3 flex-1">
                <div className="flex items-center gap-2">
                   ...
                   {module.moduleType && <ModuleTypeBadge type={module.moduleType} />}
                </div>
          ...
          <div className="px-5 flex-1 flex flex-col relative z-10">
            ...
            <div className="flex items-center gap-4 text-xs font-medium text-zinc-500 mb-4">
              ...
              <span className="flex items-center gap-1.5">
                ...
                <span className={cn(isInProgress ? styles.text : "")}>{module.xpReward} XP</span>
              </span>
            </div>
          ...
          <div className="p-5 pt-0 mt-2 relative z-10">
            {isCompleted ? (
              ...
              <Link href={`/dashboard/development/${module.id}`} className="w-full block group/btn">
                <div 
                  className={cn("p-px transition-all duration-300", styles.btnBorder)}
              ...
              >
                <Button
                  ...
                  className={cn(
                    ...
                    priority && "bg-indigo-500 text-white hover:bg-indigo-400 shadow-[0_0_15px_rgba(99,102,241,0.2)]"
                  )}
                  style={{ clipPath: "polygon(8px 0, 100% 0, 100% calc(100% - 8px), calc(100% - 8px) 100%, 0 100%, 0 8px)" }}
                >
                  {isPending ? (
