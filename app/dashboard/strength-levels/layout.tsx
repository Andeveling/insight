...
export const metadata: Metadata = {
	...
	description:
		"Desarrolla tus fortalezas a través de niveles de madurez: Esponja, Conector, Guía y Alquimista.",
};
...
export default function StrengthLevelsLayout({
	children,
}: StrengthLevelsLayoutProps) {
	return (
