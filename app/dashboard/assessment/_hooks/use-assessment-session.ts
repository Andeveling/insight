...
import type { AssessmentQuestion, AssessmentSession } from '@/lib/types/assessment.types';
import {
...
export interface UseAssessmentSessionResult {
  ...
  submitAnswer: (answer: number | string | string[], confidence?: number) => Promise<void>;
