...
export const ScaleAnswerSchema = z.number().int().min(1).max(5);

// Choice answer: non-empty string (selected option)
export const ChoiceAnswerSchema = z.string().min(1).max(500);
...
export type UserAssessmentAnswerValidated = z.infer<
	typeof UserAssessmentAnswerSchema
>;
