...
export const DomainScoresSchema = z.record(z.string().uuid(), z.number().min(0));

export const StrengthScoresSchema = z.record(z.string().uuid(), z.number().min(0));
...
export const PhaseTransitionResultSchema = z.object({
  ...
  preliminaryStrengths: z.array(z.object({
    id: z.string().uuid(),
    name: z.string(),
    score: z.number(),
  })).optional(),
...
export type AssessmentSessionValidated = z.infer<typeof AssessmentSessionSchema>;
