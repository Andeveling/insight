...
function TeamTipsSkeleton() {
	return (
		<div className="space-y-12 animate-pulse py-4">
			{/* Main Hero Skeleton */}
			<div className="p-px bg-primary/20" style={{ clipPath: CLIP_PATHS.large }}>
				<div
				...
				>
					...
					<div className="h-full flex flex-col justify-center p-10 space-y-4">
						<div className="h-8 w-1/2 bg-primary/20" style={{ clipPath: CLIP_PATHS.small }} />
						<div className="h-4 w-3/4 bg-muted/20" style={{ clipPath: CLIP_PATHS.small }} />
						<div className="pt-4 flex gap-4">
							<div className="h-12 w-48 bg-primary/30" style={{ clipPath: CLIP_PATHS.medium }} />
						</div>
					</div>
				</div>
			</div>
			...
			<div className="space-y-16">
				...
				<div className="space-y-8">
					<div className="h-10 w-64 bg-muted/20 border-b border-border/40" style={{ clipPath: CLIP_PATHS.small }} />
					<div className="p-px bg-border/20" style={{ clipPath: CLIP_PATHS.large }}>
						<div className="bg-background/30 h-48" style={{ clipPath: CLIP_PATHS.large }} />
					</div>
				</div>
							...
							>
								...
								<div className="flex-1 space-y-4">
									...
									<div className="pt-4 flex gap-2">
										<div className="h-6 w-16 bg-muted/20" style={{ clipPath: CLIP_PATHS.small }} />
										<div className="h-6 w-16 bg-muted/20" style={{ clipPath: CLIP_PATHS.small }} />
									</div>
								</div>
							</div>
