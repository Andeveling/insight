		...
		<div className="flex min-h-screen flex-col items-center justify-center bg-background relative selection:bg-destructive/30 overflow-hidden px-4">
			...
			<div className="w-full max-w-md space-y-8 relative z-10 text-center">
				...
				<div className="space-y-3">
					<div className="text-[10px] font-black uppercase tracking-[0.4em] text-destructive/60">CRITICAL_EXCEPTION_DETECTED</div>
					<h1 className="text-3xl font-black tracking-tighter uppercase">Protocolo_Fallido</h1>
				...
				{error.message && (
					...
					>
						<div className="flex items-center gap-2 mb-2">
							...
							<span className="text-[9px] font-black uppercase tracking-widest text-destructive">ERROR_LOG_OUTPUT</span>
						</div>
